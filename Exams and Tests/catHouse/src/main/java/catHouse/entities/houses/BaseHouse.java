...
public abstract class BaseHouse implements House{
    ...
    public String getStatistics() {
        return String.format("%s %s:%nCats: %s%nToys: %d Softness: %d",name,this.getClass().getSimpleName(),
                cats.size() == 0 ? "none" : cats.stream().map(Cat::getName).collect(Collectors.joining(" ")),
